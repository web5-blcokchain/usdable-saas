...
function RouteComponent() {
  ...
  const asseteData = [
    { title: t('lawyerWorkbench.offlineConfirmation.propertyAddress'), value: '上海·花园苑二区 3-1-402' },
    { title: t('lawyerWorkbench.offlineConfirmation.propertyCertificateNumber'), value: '沪房权证 2024-123456' },
    { title: t('lawyerWorkbench.offlineConfirmation.assetParty'), value: '张三' },
    { title: t('lawyerWorkbench.offlineConfirmation.contactNumber'), value: '186-0000-0000' },
    { title: t('lawyerWorkbench.offlineConfirmation.serviceWindow'), value: '浦东政务服务中心 2号窗口' },
    { title: t('lawyerWorkbench.offlineConfirmation.appointmentTime'), value: '2025-11-01 10:00' }
  ]

  const stepData = [
    {
      title: t('lawyerWorkbench.offlineConfirmation.materialPreparation'),
      content: t('lawyerWorkbench.offlineConfirmation.materialPreparationContent'),
    ...
    },
    {
      ...
      content: t('lawyerWorkbench.offlineConfirmation.informationVerificationContent'),
      endTime: ''
    },
    {
    ...
    <div className="px-22 py-13">
      ...
      <div className="mt-2">
        <div className="fyc gap-2 text-10 font-600">
          <div>上海花园苑二区</div>
          <div className="text-#00E5FF">{t('lawyerWorkbench.offlineConfirmation.executing')}</div>
        </div>
      ...
      <div className="mt-8 rounded-3 bg-#161B22 p-6">
        <div className="fyc gap-2">
          <div className="text-xl font-600">{t('lawyerWorkbench.offlineConfirmation.caseInfo')}</div>
          <div className="rounded-9999px bg-#00E6FF33 px-2 py-1 text-xs text-#00E5FF font-600">{t('lawyerWorkbench.offlineConfirmation.basicInfo')}</div>
        </div>
